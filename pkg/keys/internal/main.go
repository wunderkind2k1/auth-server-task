...
import (
	...
	"github.com/wunderkind2k1/auth-server-task/pkg/keys"
)
...
func main() {
	...
	// Create key manager
	manager, err := keys.NewManager(*keysDir)
	if err != nil {
...
func handleGenerate(manager *keys.Manager, bits int) error {
...
func handleList(manager *keys.Manager) error {
...
func handleDelete(manager *keys.Manager, keyID string) error {
